...
<html>
	<head>
		...
		<title>Reporte Sobretiempos</title>
					...
					"oTableTools": {
						"aButtons": [
							...
							"xls",
							{
								...
								"sPdfMessage": "Reporte de Sobretiempo."
							},
							"print"
						]
					}
    ...
    <br/>
		<span style="padding-left:10px" class="Titulos">Reporte Sobretiempos</span>
		<div id="container">
			<div id="demo">
				<br/>
			    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
					...
					$empleado = $_REQUEST['empleado'];
						...
						`NOMBRE_HORARIO`, `HORAFIN_HORARIO`, SUBTIME(`HORA_REGISTRO`, `HORAFIN_HORARIO`) `SEGUNDOS_ATRASO` 
										FROM registros
										...
										where `ESTADO_REGISTRO` in (0,1) and `INOUT_REGISTRO` = 1 
										and horario.codigo_horario != -1
										and SUBTIME(`HORA_REGISTRO`, `HORAFIN_HORARIO`) >= CAST("'.$sobretiempo.'" AS time)';
