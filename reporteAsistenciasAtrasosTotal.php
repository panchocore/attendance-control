...
<html>
	<head>
		...
		<title>Reporte Atrasos Total</title>
					...
					"oTableTools": {
						"aButtons": [
							...
							"xls",
							{
								...
								"sPdfMessage": "Reporte de Atrasos Totales."
							},
							"print"
						]
					}
    ...
    <br/>
		<span style="padding-left:10px" class="Titulos">Reporte Atrasos Total</span>
		<div id="container">
			<div id="demo">
				<br/>
			    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    <thead>
                        <tr>
                            ...
                            <th width="200px">Tiempo Atraso Total</th>
                        </tr>
                    </thead>
                    <tbody>
					...
					$empleado = $_REQUEST['empleado'];
						...
						$consulta = 'SELECT SEC_TO_TIME( SUM( TIME_TO_SEC( SUBTIME(`HORA_REGISTRO`, `HORAINICIO_HORARIO`) ) ) ) AS total_time
									,registros.`CODIGO_EMPLEADO` , registros.`CODIGO_HORARIO`, `NOMBRE_EMPLEADO`,	
									`NOMBRE_HORARIO`, `HORAINICIO_HORARIO`
										FROM registros
					    ...
					    if($result->num_rows > 0)
						{
							while ($row = $result->fetch_assoc()) {
								?>
		                            ...
		                            <td class="center"><?php echo $row["total_time"];?></td>
		                        </tr>
